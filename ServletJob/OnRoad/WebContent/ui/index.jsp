...
<link href="ui/assets/styles/material-components-web.min.css"
	rel="stylesheet">

<link rel="stylesheet" href="ui/assets/styles/bootstrap.min.css">
<link rel="stylesheet" href="ui/assets/styles/style.css">
<link rel="stylesheet" href="ui/assets/styles/icon.css">
<script src="ui/assets/scripts/logsign.js" type="text/javascript"></script>
...
body {
	background-image: url("ui/assets/images/bgimagereal.png");
...
<body>
	...
	<div class="navigation">
		<div class=" check  p-1">
			<nav style="backface-visibility: hidden;"
				...
				src="ui/assets/images/logo.jpg" width="30" height="30"
				...
				<div class="modal-body" style="padding: 40px 50px;">
					<form class="align-middle" action="" onsubmit="return validateForm()">
                        ...
                        <div class="mdc-form-field">
                            <div class="mdc-radio">
                                <input type="radio" class="mdc-radio__native-control forRadio" value="C" id="customer" name="userType"/>
                            ...
                            <div class="mdc-radio ">
                                <input type="radio"  class="mdc-radio__native-control forRadio" value="M" id="mechanic" name="userType"/>
                                <div class="mdc-radio__background">
                                    <div class="mdc-radio__outer-circle"></div>
                                    <div class="mdc-radio__inner-circle"></div>
                                </div>
	...
	<script type="text/javascript"
		src="ui/assets/scripts/material-components-web.min.js"></script>

	<script type="text/javascript" src="ui/assets/scripts/jquery.min.js"></script>

	<script type="text/javascript"
		src="ui/assets/scripts/jquery-3.3.1.slim.min.js"></script>

	<script type="text/javascript" src="ui/assets/scripts/popper.min.js"></script>

	<script type="text/javascript" src="ui/assets/scripts/bootstrap.min.js"></script>
</body>
</html>